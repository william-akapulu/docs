...
- `/` for the baseline prebuilt conversation flow
- `/customized` for a styled and behavior-customized version of the same flow
- local server routes under `app/api/default/akapulu/*` and `app/api/customized/akapulu/*`
