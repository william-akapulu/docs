...
- **Credits limit**: total credits available come from your plan. One live conversation minute uses **1 credit**. Scenario editor Testing Mode uses **0.25 credits** per start (see [Testing Mode](/guides/scenarios/llm-test-mode)).
