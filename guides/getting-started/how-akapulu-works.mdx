---
title: "How it works"
description: "High-level overview of live conversations and scripted video clips."
---

## About Akapulu Labs

- Akapulu Labs is an AI research lab building a platform for AI avatars: live conversations and scripted video clips.
- **Live conversations:** AI assistants (bots) that join calls with users. The user speaks naturally, and the bot listens, responds in real time, and follows your configured instructions and tools.
- **Scripted clips:** you supply a script; Akapulu Labs generates talking-avatar audio and video. That flow is in [Scripted video clips](/guides/clips/overview). The rest of this page is the live conversation pipeline.

<img src="/images/guides/getting-started/How-akapulu-works/Akapulu_Demo_Image.png" alt="Live conversation: AI assistant on a call with a user, transcript on the right" style={{ borderRadius: 12 }} />
...
<img
  ...
  alt="Akapulu Labs pipeline diagram"
...
<img
  ...
  alt="During the call, the current LLM prompt and node (Intake) drive the live conversation UI"
  style={{ borderRadius: 12, margin: "0 auto", display: "block" }}
/>
...
- Generate a talking-avatar video from a script: [Scripted video clips](/guides/clips/overview).
