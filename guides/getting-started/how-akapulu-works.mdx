...
2. Then, to start a conversation, call the [`/connect`](/api-reference/conversations/connect) endpoint and passes the `scenario_id` you want to use to guide bot behavior. 
...
3. The user then joins the same call, and your ready to go!
