...
3. Create a transition function with a clear name and description.
4. Drag the probe on the right side of the function to the node you wish to transition to

![Add a transition function in the scenario UI (1.5x speed)](/images/guides/tools/transition/add%20transition%20func.gif)
...
![Drag a tool to set transition target in the scenario UI (1.5x speed)](/images/guides/tools/transition/drag_endpoint_to_new_node.gif)
