...
<Note>
Right now this alphabet is **American** English. Other accents and languages are coming soon.
</Note>

How to send `text` vs `phonemes` on create is in [Workflow](/guides/clips/workflow). Most symbols below follow Misaki’s [`EN_PHONES.md`](https://github.com/hexgrad/misaki/blob/main/EN_PHONES.md). One extra: unstressed *a* / *an* / *am* use `ɐ`, which that table omits but Misaki still emits.
