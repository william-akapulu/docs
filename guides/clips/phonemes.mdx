...
How to send `text` vs `phonemes` on a take is in [Workflow](/guides/clips/workflow). The symbol notes below follow Misaki’s [`EN_PHONES.md`](https://github.com/hexgrad/misaki/blob/main/EN_PHONES.md).
