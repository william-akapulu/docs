...
The same catalog `avatar_id` is what you send when you [create a take](/api-reference/takes/create). Clips do not use a scenario.

Live conversation avatars can still look different from clip avatars today. Live will be updated to match clip look; see the note on [clips overview](/guides/clips/overview).
