...
The same catalog `avatar_id` is what you send when you [create a clip](/api-reference/clips/create). Live conversations and clips use the same catalog avatars.
