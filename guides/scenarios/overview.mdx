...
Akapulu supports the following OpenAI models. For official specifications and pricing, see [OpenAI’s model documentation](https://platform.openai.com/docs/models).
...
Akapulu combines a global **role instruction** with each node’s **task instruction** to decide what the model should do at every stage. For how that context is assembled and how to write both fields, see [Role and task instructions](/guides/scenarios/role-and-task-instructions).
