...
1. It starts with the start node's **role message** and **task message**.
2. It appends each **user** and **assistant** message turn.
3. On node transition, it appends the new node's **role message** and **task message**.

We recommend defining your overall assistant persona in the start node's **role message**, and use each node's **task message** for stage-specific behavior.
