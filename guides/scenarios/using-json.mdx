...
- Use `allowed_next_nodes` to have Akapulu choose the next node dynamically from the function response. (See [Endpoints](/guides/endpoints/create-endpoint))
...
- function keys are limited to `name`, `description`, `type`, `transition_to`, `allowed_next_nodes`, `endpoint_id`, `knowledge_base_id`, and `parameters`
