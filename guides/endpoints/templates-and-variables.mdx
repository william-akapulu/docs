...
![Variable syntax diagram](/images/guides/tools/endpoints/templates-and-variables/variable%20syntax%20diagram.png)
...
![Templates and variables diagram](/images/guides/tools/endpoints/templates-and-variables/templates%20and%20variables%20diagram.png)
...
![Akapulu syntax for functions](/images/guides/tools/endpoints/templates-and-variables/Akapulu%20syntax%20functions.png)

### Pre-actions and post-actions (automatic)

These run automatically on node lifecycle and are not called by the LLM.

![Akapulu syntax for pre/post actions](/images/guides/tools/endpoints/templates-and-variables/akapulu%20syntax%20pre%20post%20action.png)
