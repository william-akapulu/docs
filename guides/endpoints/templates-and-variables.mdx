...
<img src="/images/guides/tools/endpoints/templates-and-variables/Akapulu%20syntax%20functions.png" alt="Akapulu syntax for functions" style={{ borderRadius: 12 }} />

### Pre-actions and post-actions (automatic)

These run automatically on node lifecycle and are not called by the LLM.

<img src="/images/guides/tools/endpoints/templates-and-variables/akapulu%20syntax%20pre%20post%20action.png" alt="Akapulu syntax for pre/post actions" style={{ borderRadius: 12 }} />
