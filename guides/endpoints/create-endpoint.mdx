...
For HTTP tools, `functions[].function.name` is the tool-call name presented to the LLM. Use clear action names like `book_appointment`, `create_lead`, or `lookup_order`.
...
![Attach HTTP endpoint as function tool in scenario UI (2x speed)](/images/guides/tools/endpoints/create-endpoint/attach-http-function-ui.gif)
...
![Attach HTTP endpoint as pre/post action in scenario UI (1.5x speed)](/images/guides/tools/endpoints/create-endpoint/attach-http-action-2.gif)
