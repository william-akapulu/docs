...
![Attach HTTP endpoint as function tool in scenario UI (2x speed)](/images/examples/attach-http-function-ui.gif)
...
![Attach HTTP endpoint as pre/post action in scenario UI (1.5x speed)](/images/examples/attach-http-action-2.gif)
