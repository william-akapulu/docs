...
A Python CLI for [scripted video clips](/guides/clips/overview): create a clip from a script, then download audio and video.

<CardGroup cols={1}>
  <Card title="Scripted clip workflow" icon="clapperboard" href="/examples/clips/scripted-clip-workflow">
    Create a clip from a script, then download audio and video.
  </Card>
</CardGroup>
