...
<img className="block dark:hidden" src="/images/examples/healthcare-intake-nodes-light.svg" alt="Healthcare intake scenario node flow (light)" />
<img className="hidden dark:block" src="/images/examples/healthcare-intake-nodes-dark.svg" alt="Healthcare intake scenario node flow (dark)" />
