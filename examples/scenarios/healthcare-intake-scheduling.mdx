...
Create these secrets in the [Akapulu Labs secrets tab](https://akapulu.com/secrets):
...
- **Upload this file**
  - [`Clinic-Details.md`](https://github.com/Akapulu/healthcare-intake-scheduling/blob/main/knowledge-base/Clinic-Details.md)
...
Web SDK examples you can pair with this scenario:
...
const connectPayload = {
  ...
  // Overlay a This is AI label on the live video
  show_ai_label: false,
};
