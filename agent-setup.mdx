...
The env var name is `AKAPULU_API_KEY`. Put it in this project however env vars are already loaded (`.env`, `.env.local`, host secrets, etc.). Do not ask them to paste the key into chat.
