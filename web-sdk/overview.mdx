...
| --- | --- | --- | --- |
| `@akapulu/server` | Server-side client for calling Akapulu APIs | Server | `1.0.4` |
| `@akapulu/react` | React provider, hooks, media controls, and event subscriptions | React app | `1.0.6` |
| `@akapulu/react-ui` | Prebuilt React conversation UI on top of `@akapulu/react` | React app | `1.0.9` |
