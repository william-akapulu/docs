...
| `@akapulu/react` | React provider, hooks, media controls, and event subscriptions | React app | `1.0.5` |
| `@akapulu/react-ui` | Prebuilt React conversation UI on top of `@akapulu/react` | React app | `1.0.8` |
