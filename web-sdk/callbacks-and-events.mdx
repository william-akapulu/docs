...
Fired once, about 30 seconds before a live call hits its duration cap. `AkapuluConversation` shows this as a banner on the video. The call stays connected. Rooms of 30 seconds or less do not send it.
